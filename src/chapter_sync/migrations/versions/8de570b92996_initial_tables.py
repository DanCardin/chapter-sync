...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["series_id"], ["series.id"], name=op.f("series_subscriber_series_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["subscriber_id"],
            ["subscriber.id"],
            name=op.f("series_subscriber_subscriber_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("series_subscriber_pkey")),
        sa.UniqueConstraint(
            "series_id",
            "subscriber_id",
            name=op.f("series_subscriber_series_id_subscriber_id_key"),
        ),
    )
    op.create_table(
        "chapter_send_event",
        ...
        sa.ForeignKeyConstraint(
            ["chapter_id"],
            ["chapter.id"],
            name=op.f("chapter_send_event_chapter_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["series_subscriber_id"],
            ["series_subscriber.id"],
            name=op.f("chapter_send_event_series_subscriber_id_fkey"),
        ),
        sa.PrimaryKeyConstraint(
            "id",
            name=op.f("chapter_send_event_pkey"),
        ),
        sa.UniqueConstraint(
            "chapter_id",
            "series_subscriber_id",
            name=op.f("chapter_send_event_chapter_id_series_subscriber_id_key"),
        ),
    )
